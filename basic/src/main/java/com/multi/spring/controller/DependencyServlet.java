...
public class DependencyServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//4. 스프링 컨테이너를 사용한 객체 생성하기 (xml)- xml 문서를 읽어  객체에 대한 결합도 를 xml 파일에 양도 ,
		// 개발자가 더이상 new로 객체 생성할 필요가 없다.
		...
		Singer singer = (cntx.getBean("singerMgt",SingerMgt.class)).getSinger(); //이름, 타입으로
